package org.firstinspires.ftc.teamcode.toMigrate.roadrunnerscripts;
...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1639.3430805082312; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3292.352631665819; // x position of the perpendicular encoder (in tick units)
    }
